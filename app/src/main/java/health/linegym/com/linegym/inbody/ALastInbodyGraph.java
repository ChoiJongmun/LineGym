...
public class ALastInbodyGraph extends BaseLineGymActivity implements OnChartValueSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        title.setText("이전 측정 내역 그래프 영역");
        findViewById(R.id.comm_title_btn_navi_back).setOnClickListener(onBaseClickListener);

        mChart = (LineChart) findViewById(R.id.gragh_inbody_detail_info);
