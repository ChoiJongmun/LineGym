...
public class CaldroidFragment extends DialogFragment {
     ...
     */
    protected Map<String, Drawable> backgroundForDateTimeMap = new HashMap<>();

    /**
     * textColorForDateMap holds color for text for each date
     */
    protected Map<String, Integer> textColorForDateTimeMap = new HashMap<>();
    ;
     ...
     */
    public Map<String, Drawable> getBackgroundForDateTimeMap() {
        return backgroundForDateTimeMap;
    }

    public Map<String, Integer> getTextColorForDateTimeMap() {
    ...
    public void setBackgroundDrawableForDates(
            Map<String, Drawable> backgroundForDateMap) {
        ...
        for (String date : backgroundForDateMap.keySet()) {
            Drawable drawable = backgroundForDateMap.get(date);
            backgroundForDateTimeMap.put(date, drawable);
        }
    }
    ...
    public void setBackgroundDrawableForDateTimes(
            Map<String, Drawable> backgroundForDateTimeMap) {
    ...
    public void setBackgroundDrawableForDate(Drawable drawable, String date) {
        backgroundForDateTimeMap.put(date, drawable);
    }
    ...
    public void clearBackgroundDrawableForDateTime(String dateTime) {
        backgroundForDateTimeMap.remove(dateTime);
    }
     ...
     * @return
     */
    public void setTextColorForDates(Map<String, Integer> textColorForDateMap) {
        ...
        for (String date : textColorForDateMap.keySet()) {
            Integer resource = textColorForDateMap.get(date);
            textColorForDateTimeMap.put(date, resource);
        }
    }

    public void clearTextColorForDates(List<String> dates) {
    ...
    public void setTextColorForDateTimes(
            Map<String, Integer> textColorForDateTimeMap) {
        this.textColorForDateTimeMap.putAll(textColorForDateTimeMap);
    }

    public void setTextColorForDate(int textColorRes, String date) {
        textColorForDateTimeMap.put(date, textColorRes);
    }

    public void clearTextColorForDate(String date) {
        textColorForDateTimeMap.remove(date);
    }

    public void setTextColorForDateTime(int textColorRes, String dateTime) {
